...
static EXPANDED_RECORD: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"-\[ RECORD \d+ \]-").unwrap());
...
static RECORD_HEADER: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"^-\[ RECORD (\d+) \]-").unwrap());
