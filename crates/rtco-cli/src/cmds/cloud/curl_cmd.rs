...
pub fn run(args: &[String], verbose: u8) -> Result<i32> {
    ...
    let shown = runner::emit_guarded(&filtered.content, filtered.tee_hint.as_deref(), &raw);
...
mod tests {
    ...
    fn test_is_binary_text_with_nul_is_not_binary() {
        // NUL is valid UTF-8; only invalid sequences are binary for our purpose
