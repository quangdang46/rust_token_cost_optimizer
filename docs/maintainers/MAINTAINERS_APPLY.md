# RTCO Maintainers Application

RTCO is growing fast, with more contributors, PRs, and ideas than ever. To keep things moving smoothly, we're looking for new maintainers.
...
- 3+ merged PRs to RTCO (filters, fixes, docs — all contributions count)
...
1. Open a discussion in [rtco-ai/rtco Maintainers Applications · Discussions · GitHub](https://github.com/rtco-ai/rtco/discussions/categories/maintainers-applications) titled **Maintainer Application: [Your GitHub Handle]**
2. In your application, include:
   ...
   - Your PRs that have been accepted in RTCO
...
- A review of your ecosystem experience and understanding of RTCO concepts
...
- Maintain consistency with the rest of the RTCO ecosystem
...
Core Maintainers are responsible for the core of RTCO. They have a broader scope and higher responsibilities and permissions, including:
...
If you enjoy contributing and want to help RTCO scale in a healthy way, we'd be excited to have you onboard 🚀
