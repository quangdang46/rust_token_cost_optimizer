...
> ⚠️ **Name collision**: If `rtco gain` fails, you may have `reachingforthejack/rtco`
> (Rust Type Kit) installed instead. Check `which rtco` and reinstall from rtco-ai/rtco.
